...
@SuppressLint("DrawAllocation") public class RoundedImageView extends ImageView {
	...
	@SuppressLint("Recycle") public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		if (attributes.getBoolean(R.styleable.CircularImageView_border, true)) {
			...
			setBorderColor(attributes.getColor(
					R.styleable.CircularImageView_border_color, (Color.parseColor("#ffd73a"))));
		}
